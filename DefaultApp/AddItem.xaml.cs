...
namespace DefaultApp
{
    ...
    public sealed partial class AddItem : Page
    {
        ...
        {
            var page = (string)e.NavigationParameter;
            pageTitle.Text = "Add " + page;
            fieldTitle.Text = page;
            switch(page)
            {
                case "Weight":
                    fieldValueUnit.Text = "Kg";
                    break;
                case "Blood Pressure":
                    fieldValueUnit.Text = "mmHg";
                    break;
                case "Blood Glucose":
                    fieldValueUnit.Text = "mmol/L";
                    break;
                case "Height":
                    fieldValueUnit.Text = "ft";
                    break;
                case "Cholesterol":
                    fieldValueUnit.Text = "mg/dL";
                    break;
                default:
                    break;
